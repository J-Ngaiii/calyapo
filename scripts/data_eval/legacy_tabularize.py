...
def get_base_data_path(train_plan: str, filetype: str = 'jsonl', verbose=False):
    path_conf = {
        'train' : UNIVERSAL_FINAL_FOLDER / Path(f"{train_plan}_train.{filetype}"), 
        'val' : UNIVERSAL_FINAL_FOLDER / Path(f"{train_plan}_val.{filetype}"), 
        'test' : UNIVERSAL_FINAL_FOLDER / Path(f"{train_plan}_test.{filetype}")
    }
    return path_conf
